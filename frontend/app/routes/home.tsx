...
import ICON_SPOTIFY from "~/icons/icon-spotify.svg";
import ICON_YOUTUBE from "~/icons/icon-youtube.svg";
...
export default function Home() {
  ...
  return (
    <>
      <div className="flex flex-col justify-between items-center gap-3 md:flex-row w-[95vw] md:w-[90vw] m-auto py-4 md:fixed md:inset-[0_0_auto_0] z-[1] bg-gray-50">
        <h1 className="flex items-center gap-2 text-teal-800 text-3xl font-bold">
          <img src={ICON_HEADPHONE} className="size-7" />
          <span className="hidden md:block">Music Shuffler</span>
        </h1>
        <div className="flex justify-between items-end gap-3 md:w-[50rem]">
      ...
      <main className="flex justify-center md:justify-between items-stretch flex-col md:flex-row gap-10 w-[95vw] max-w-[60rem] m-auto">
        <div className="flex flex-col items-start gap-6 flex-none size-fit max-w-[32rem] mx-auto md:m-0 md:pt-24 md:sticky top-0">
          ...
          <div className="flex flex-col items-stretch gap-2 flex-grow w-full">
        ...
        <ul className="flex flex-col items-stretch gap-1.5 flex-grow md:pt-24 pb-8">
